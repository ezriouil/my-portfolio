      ...
      body: SingleChildScrollView(
        child: Column(children: [
          ...
          Container(
            ...
            color: CustomColors.PRIMARY_1,
            padding: EdgeInsets.only(left: CustomSizes.WEB_SPACE_BETWEEN_SECTIONS, top: CustomSizes.WEB_SPACE_BETWEEN_ITEMS),
            child: Row(
              children: [
                Expanded(
                    flex: 3,
          ...
          Container(
            width: getWidth(context),
            color: CustomColors.PRIMARY_1,
            padding: EdgeInsets.only(bottom: CustomSizes.WEB_SPACE_BETWEEN_SECTIONS,
                left: CustomSizes.WEB_SPACE_DEFAULT,right: CustomSizes.WEB_SPACE_DEFAULT,),
            child: Row(
              children: [
                Row(
                  children: [
                    Text("3 ",
                        style: Theme.of(context)
                            .textTheme
                            .headlineLarge
                            ?.copyWith(fontSize: CustomSizes.WEB_SPACE_BETWEEN_SECTIONS*2)),
                    Text("YEARS OF\nEXPERIENCE",
                        style: Theme.of(context)
                            .textTheme
                            .titleMedium
                            ?.copyWith(
                            fontSize: CustomSizes.WEB_SPACE_DEFAULT/1.5, color: CustomColors.PRIMARY_3))
                  ],
                ),
            ...
            child: Column(
              ...
              children: [
                ...
                Stack(
                  ...
                  children: [
                    WidgetAnimator(
                      atRestEffect: WidgetRestingEffects.pulse(curve: Curves.easeInBack),
                      child: Image.asset("assets/images/lightning.png",
                          height: 450),
                    ),
                    Column(
                ...
                Container(
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) => Padding(
                            padding:
                                EdgeInsets.all(CustomSizes.WEB_SPACE_BETWEEN_ITEMS/2),
                            child: Container(
                              width: 300,
                              padding: EdgeInsets.all(CustomSizes.WEB_SPACE_BETWEEN_ITEMS),
                ...
                CustomTextField(hint: "Your Name", validator: (validator){}, controller: TextEditingController())
              ],
            ),
          ),
